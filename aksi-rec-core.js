...
let lastQA=null; // {q,a,id?,engine} for feedback recursion
...
/** Memory with weights — recursive boost. Teach/correct match on answer text too. */
function memHits(q, limit=5){
  ...
  for(const m of memories){
    ...
    // pure answer-body hits count for teach/correct (they may have short keys)
    let bodyHit=0;
...
function synthesize(q, parts){
  ...
  // High-weight teach/correct/seal wins — this is the recursive loop
