...
This module intentionally distinguishes integrity from truth: a valid signature proves
that an authorized key signed bytes; it does not prove that the underlying claim is true.
"""
...
class CognitiveLedger:
    """Append-only in-memory ledger; persistence can be supplied by the host app."""
